...
function inputViz(divContainer, 
                       svgSettings={width: 500, 
                                    ...
                                    gridIntervel: 8}, eventHandlers={onClick: ()=>{}, onDrag: ()=>{}}){
  ...
  // this.getSvgId = () =>{return }
   function init(){
    svgSettings = {width: svgSettings.width || 500, 
                                    ...
                                    margin: {top: (svgSettings.margin)? svgSettings.margin.top || 30 : 30 ,
                                             right: (svgSettings.margin)? svgSettings.margin.right ||  30 : 30 , 
                                             bottom: (svgSettings.margin)? svgSettings.margin.bottom || 30 : 30, 
                                             left: (svgSettings.margin)? svgSettings.margin.left || 30 : 30 },
    ...
    let afterGridSpace = svg.append('g').attr('id', 'beforeGrid');
    ...
    originAxis
      ...
      components = {
        svg, svgSettings, originAxis, conversionFns: {x,y,xInv,yInv}, spaces: {beforeGridSpace, afterGridSpace}
      }
